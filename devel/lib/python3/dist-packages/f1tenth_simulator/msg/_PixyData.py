...
"""autogenerated by genpy from f1tenth_simulator/PixyData.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','f1tenth_simulator/PixyBlock[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = f1tenth_simulator.msg.PixyBlock()
        _x = val1
        start = end
        end += 4
