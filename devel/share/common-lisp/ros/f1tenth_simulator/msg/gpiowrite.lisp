...
(cl:defmethod cl:initialize-instance :after ((m <gpiowrite>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gpiowrite)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_simulator-msg:<gpiowrite> is deprecated: use f1tenth_simulator-msg:gpiowrite instead.")))
...
(cl:defmethod duration-val ((m <gpiowrite>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_simulator-msg:duration-val is deprecated.  Use f1tenth_simulator-msg:duration instead.")
  (duration m))
