...
(cl:defclass <PixyData> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (blocks
    :reader blocks
    :initarg :blocks
    :type (cl:vector f1tenth_simulator-msg:PixyBlock)
   :initform (cl:make-array 0 :element-type 'f1tenth_simulator-msg:PixyBlock :initial-element (cl:make-instance 'f1tenth_simulator-msg:PixyBlock))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PixyData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PixyData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_simulator-msg:<PixyData> is deprecated: use f1tenth_simulator-msg:PixyData instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PixyData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_simulator-msg:header-val is deprecated.  Use f1tenth_simulator-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'blocks-val :lambda-list '(m))
(cl:defmethod blocks-val ((m <PixyData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_simulator-msg:blocks-val is deprecated.  Use f1tenth_simulator-msg:blocks instead.")
  (blocks m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PixyData>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'blocks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'f1tenth_simulator-msg:PixyBlock))
