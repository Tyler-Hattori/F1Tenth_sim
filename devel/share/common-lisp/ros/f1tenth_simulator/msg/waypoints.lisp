...
(cl:defmethod cl:initialize-instance :after ((m <waypoints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'waypoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_simulator-msg:<waypoints> is deprecated: use f1tenth_simulator-msg:waypoints instead.")))

(cl:ensure-generic-function 'xs-val :lambda-list '(m))
(cl:defmethod xs-val ((m <waypoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_simulator-msg:xs-val is deprecated.  Use f1tenth_simulator-msg:xs instead.")
  (xs m))

(cl:ensure-generic-function 'ys-val :lambda-list '(m))
(cl:defmethod ys-val ((m <waypoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_simulator-msg:ys-val is deprecated.  Use f1tenth_simulator-msg:ys instead.")
  (ys m))
