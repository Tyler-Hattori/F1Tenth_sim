...
(cl:defmethod cl:initialize-instance :after ((m <seenPoints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'seenPoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_simulator-msg:<seenPoints> is deprecated: use f1tenth_simulator-msg:seenPoints instead.")))

(cl:ensure-generic-function 'indices-val :lambda-list '(m))
(cl:defmethod indices-val ((m <seenPoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_simulator-msg:indices-val is deprecated.  Use f1tenth_simulator-msg:indices instead.")
  (indices m))

(cl:ensure-generic-function 'confidences-val :lambda-list '(m))
(cl:defmethod confidences-val ((m <seenPoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_simulator-msg:confidences-val is deprecated.  Use f1tenth_simulator-msg:confidences instead.")
  (confidences m))
